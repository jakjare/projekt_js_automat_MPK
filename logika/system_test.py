...
import unittest
import pieniadze, bilety, system
...
class TestSystem(unittest.TestCase):
    def test_opis_1(self):
        ...
        self.automat.dodaj_bilet(bilety.Bilety("1", "normalny", 3))         # Dodaję bilet.
    ...
    def test_opis_5(self):
        ...
        self.automat = system.System()                                      # Tworzę obiek automatu MPK.
        self.automat.dodaj_bilet(bilety.Bilety("1", "normalny", 3))         # Dodaję bilet, który kosztuje 1 zł.
